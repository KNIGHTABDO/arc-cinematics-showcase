...
function ProfileModal({
  ...
  return (
    ...
    >
      <div
        className="bg-arc-surface border border-white/10 rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl"
      ...
      >
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between bg-arc-surface-2 border border-white/10 rounded-lg px-4 py-3">
            ...
            >
              <div
                className={`h-5 w-5 rounded-full bg-white shadow transition-transform ${isKids ? "translate-x-6" : "translate-x-0.5"}`}
              />
            </button>
          </div>
        </div>
        ...
        <div className="flex gap-3 mt-8">
          <button
            onClick={onClose}
            className="flex-1 py-3 rounded-lg border border-white/10 text-arc-muted hover:text-white transition font-semibold text-sm"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 py-3 rounded-lg bg-arc-accent text-arc-void font-bold text-sm hover:bg-white transition disabled:opacity-50"
          >
